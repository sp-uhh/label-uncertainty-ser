...
Available variants,
1. Model Uncertainty (MU): 'ModelVariant.model_uncertainty'
2. Label Uncertainty (MU+LU): 'ModelVariant.label_uncertainty'
3. *t*-distribution Label Uncertainty (t-LU): 'ModelVariant.tstud_label_uncertainty'
